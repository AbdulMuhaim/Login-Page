...
function Login(onLogin) {
  ...
  const [userEmail,setUserMail] = useState("john.doe@abc.com");
  const [userPassword,setUserPassword] = useState("Smage@2023");
  ...
  const handleLogin = () => {
      if(signup) return notification.error({message: "This service is temporarily suspended"}) 
      ...
      <div className="flex items-center justify-cente w-[100vw] h-[100vh]">
        <div className="login-form w-1/2">
          ...
          <div className="max-w-md mx-auto m-8 bg-white pl-11 text-xs md:text-base">
                  ...
                  <>
                    ...
                    <div className="modal">
                      <div className="modal-content">
                        ...
                        <h2 className="text-black text-xl">Forgot Password</h2>
                        ...
                        <button
                          onClick={sendOtp}
                          className="mb-4 bg-blue-500 ml-3 p-2 rounded hover:bg-blue-600 text-white"
                        >
                          Send OTP
                        </button>
                      </div>
            ...
            <br />
            <div className="flex items-center justify-center">
              <p style={{ color: "#232D42" }} className="text-xs md:text-base">
